...
#include "../../lib_aliot_v2/ota/ota_internal.h"
#include "../../lib_aliot_v2/ota/ota_lib.c"
#include "../../lib_aliot_v2/sdk-impl/exports/iot_export_ota.h"
#include "../../lib_aliot_v2/sdk-impl/imports/iot_import_ota.h"

#if (OTA_CH_SIGNAL_MQTT) != 0
#include "../../lib_aliot_v2/ota/ota_mqtt.c"
#elif (OTA_CH_SIGNAL_MQTT) != 0
#include "../../../lib_aliot_v2.0/ota/ota_coap.c"
#else
#error "NOT support yet!"
#endif

#if (OTA_CH_FETCH_HTTP) != 0
#include "../../lib_aliot_v2/ota/ota_fetch.c"
#else
#error "NOT support yet!"
#endif
