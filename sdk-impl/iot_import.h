...
#include "../platform/os/mico/hardware/lite_gprs_network.h"
...
/*********************** redefine datatype to adapt to mico system *********************/
#define uintptr_t int


/********************************** function select*************************************/
#define MQTT_DIRECT         //connect to cloud directly

#define IOTX_WITHOUT_TLS    //don't use TLS

#define EMG3062             //GPRS IDS
